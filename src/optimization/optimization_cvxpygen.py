...
from cvxpygen import cpg   # debug needed for the cpp compilation
import pickle
import importlib
...
class NonConvexOCP():
    ...
    def __init__(self,
        ...
        if self.cvxpygen: 
            ...
            import sandbox.cpg_ocp_cvx_AL.cpg_solver as cpg_module
    ...
    def build_ocp_cvx_AL(self):
        ...
        if self.cvxpygen: 
            ...
            self._solve_problem(self.prob_AL, solver=cp.ECOS)
    ...
    def solve_cvx_AL(self):
        ...
        try:
            ...
            if self.cvxpygen:
                ...
                self._solve_problem(self.prob_AL, method='CPG')
            else:
