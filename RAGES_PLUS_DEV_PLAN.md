...
- Next structural target is running item 6 at full scale (`work/datagen_wyp.py`, N=80k), then doing the small item 7--9 training-script cleanup needed to swap GMM, VAE, and flow from one command.
